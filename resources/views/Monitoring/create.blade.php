    ...
    <form action="{{ route('monitoring.store') }}" method="POST">
        ...
        <div class="row mt-2 mb-2">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('leader') is-invalid @enderror" name="leader" id="leader" value="{{ old('leader') }}">
                @error('leader')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="row mb-2">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('client') is-invalid @enderror" name="client" id="client" value="{{ old('client') }}">
                @error('client')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control @error('progress') is-invalid @enderror" min="0" max="100" name="progress" id="progress" value="{{ old('progress') }}">
                @error('progress')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
